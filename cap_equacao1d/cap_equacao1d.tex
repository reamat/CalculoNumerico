...
Do \emph{teorema do ponto fixo}\index{teorema do!ponto fixo} temos que a taxa de convergência é dada em função do valor absoluto da derivada de $\phi(x)$. Calculando a derivada temos:
\begin{equation*}
