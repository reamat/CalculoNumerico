...
\begin{eqnarray*}
  u'(t)  &=& \sqrt{u(t)+1} \\
  u(0) &=& 0
\end{eqnarray*} Resolva numéricamente esse problema pelos seguintes métodos:
\begin{enumerate}
 \item Runge-Kutta segunda ordem.
\end{enumerate}


pelo método de Adams-Bashforth de segunda ordem e pelo método preditor corretor combinando Adams-Bashforth de segunda order com Adams-Moulton de segunda ordem. Compare a solução obtida para $t=10$ com a solução exata dada por:
$$u(t)=\frac{t^2+t}{4}.$$
