...
\chapter{Integração numérica}\index{integração} \label{cap_integra}
...
\subsection{Regra do trapézio}\index{integração numérica!regra do trapézio}\label{int:trapézio}
