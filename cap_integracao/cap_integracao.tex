...
A regra do trapézio consiste em aproximar a função $f$ por um polinômio de grau 1. Se utilizarmos uma reta ligando os extremos do intervalo obtemos um trapézio que fornece o nome da regra. 
...
Vimos nas seções anteriores que podemos encontrar os coeficientes $A_i$ de uma regra de quadratura integrando os polinômios de Lagrange.

Nesta seção veremos um outro método para obter os coeficientes, que torna-se bastante útil para quando temos muitos pontos ou quando o intervalo entre os pontos não é uniforme.
...
Acumulamos o valor da integral em \verb+S+. No código abaixo temos o método de Simpson, mas basta trocarmos a fórmula para termos outras quadraturas.
...
\begin{Exercise}
Calcule numericamente as seguintes integrais usando os métodos simples do Ponto médio, Trapézio e Simpson. Calcule também o valor exato usando seus conhecimentos de Cálculo I. Complete a tabela abaixo conforme modelo:
\begin{center}
\begin{tabular}{|c|c|c|c|c|}
\hline
