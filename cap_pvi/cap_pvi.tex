...
\subsection{Métodos de Runge-Kutta com dois estágios}\label{sec:RK_2_subsec}
...
\section{Problemas rígidos}\index{problema!rígido}\index{problema!stiff}\label{sec:stiff}
\emconstrucao
