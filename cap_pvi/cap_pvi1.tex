...
\end{eqnarray}
onde $p(t)$ é polinômio de grau $s-1$ dada forma de Lagrange por:
...
\begin{eqnarray*}
 ...
 y(0)&=& 0
\end{eqnarray*}
aplicando o método de Adams-Bashforth de dois passos e inicializando o método através do método de Euler modificado. Calcule o valor de $y(1)$ com passo de tamanha $h=0,1$.
\end{exeresol}
\begin{resol} 
