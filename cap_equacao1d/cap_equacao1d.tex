...
\end{verbatim}
  e, assim, sucessivamente. Veja o código completo na Seção~\ref{subec:codigo_bissecao}.
\fi    
\end{sol}
...
\ifisscilab
\subsection{Código Scilab: método da bisseção}\label{subec:codigo_bissecao}
