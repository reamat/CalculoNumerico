...
\let\stdsection\section                                   % inicia cada secao em nova página
\renewcommand\section{\newpage\stdsection}

\let\stdsubsection\subsection                             % inicia cada subsecao em nova página
\renewcommand\subsection{\newpage\stdsubsection}

\let\stdsubsubsection\subsubsection                       % inicia cada subsubsecao em nova página
