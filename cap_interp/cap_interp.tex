...
\begin{equation*}
  \mathbb{P}_{n-1} := \left\{p : x\mapsto p(x) = \sum_{i=0}^{n-1}a_ix^i ;\, \{a_0,a_1,\ldots,a_{n-1}\}\in\mathbb{R}\right\},
\end{equation*}
...
\begin{figure}
  ...
  \caption{Polinômio interpolador do conjunto de pontos $\{(0, 1)$, $(1, 2)$, $(2, -3)$, $(3, -20)\}$. Veja o Exemplo~\ref{ex:interpolacao_polinomial}.}\label{fig:ex_interpolacao_polinomial}
\end{figure}

\begin{ex}\label{ex:interpolacao_polinomial} Encontre o polinômio interpolador do conjunto de pontos $\{(0, 1)$, $(1, 2)$, $(2, -3)$, $(3, -20)\}$.
\end{ex}
\begin{sol}
...
\begin{equation*}
  \begin{array}{lclclclcl}
    a_1& & & & & & &=&1\\
    a_1&+& a_2&+& a_3&+&  a_4&=&2\\
    a_1&+&2a_2&+&4a_3&+& 8a_4&=&-3\\
    a_1&+&3a_2&+&9a_3&+&27a_4&=&-20
  \end{array}
\end{equation*}
cuja solução é $a_0=1$, $a_1=2$, $a_2=0$ e $a_3=-1$. Portanto, o polinômio interpolador é $p(x)=1+2x-x^3$. Veja Figura~\ref{fig:ex_interpolacao_polinomial}.
...
>>> yi = np.array([1,2,-3,-20], dtype='double')
