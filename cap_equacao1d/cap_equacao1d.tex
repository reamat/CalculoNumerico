...
\subsection*{Exercícios}
\begin{exer}
Encontre a raiz positiva da função $f(x)=\cos(x)-x^2$ pelo método de Newton inicializando-o com $x^{(0)}=1$. Realize a iteração até obter estabilidade no $quinto$ dígito siginificativo.
\end{exer}
\begin{resp}
