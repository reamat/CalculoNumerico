...
Neste apêndice, discutiremos os principais aspectos da linguagem computacional \verb+GNU Octave+ que são excenciais para uma boa leitura desta versão do livro. O material aqui apresetado, é uma adaptação livre do Apêndice A de \cite{CALSCI}.
...
\end{verbatim}
Qual é a saída apresentada no console do \verb+GNU Octave+? Porquê?
\end{ex}
