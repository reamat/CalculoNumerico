...
\newcommand{\emconstrucao}{
  \begin{tabular}{|c|}\hline
    ...
    \url{http://www.ufrgs.br/numerico/participe.html}\\\hline
  \end{tabular}
}
...
\begin{center}
  ...
  \url{http://github.com/livroscolaborativos/CalculoNumerico}  
\end{center}
}
...
\newcommand{\construirExeresol}{
  \begin{center}
    \begin{tabular}{|c|}\hline
      ...
      Veja como em:\\
      \url{http://github.com/livroscolaborativos/CalculoNumerico}\\\hline
    \end{tabular}
  \end{center}
}
