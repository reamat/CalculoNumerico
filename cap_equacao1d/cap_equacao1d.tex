...
\item[b)]  Considere a função \begin{equation} g(x)=10\exp(-x) \end{equation} e função composta $\psi(x)=g\circ g=g\left(g(x)\right)$. Mostre que $\psi$ possui dois pontos fixos que não são pontos fixos de $g$.
